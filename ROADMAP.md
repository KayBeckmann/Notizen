...
- [ ] 1.1.1 `flutter create` mit Organisation und Projektname ausführen
- [ ] 1.1.2 Plattform-Support aktivieren (Android, iOS, Windows, Linux, Web)
- [ ] 1.1.3 Minimale SDK-Version festlegen (Flutter 3.16+, Dart 3.2+)
- [ ] 1.1.4 `.gitignore` anpassen für Flutter-Projekt
...
#### 2.2.1 Folders Table
- [ ] 2.2.1.1 `id` (UUID, Primary Key)
- [ ] 2.2.1.2 `name` (Text, nicht leer)
- [ ] 2.2.1.3 `color` (Integer, Hex-Wert)
- [ ] 2.2.1.4 `icon` (Text, Icon-Name)
- [ ] 2.2.1.5 `parentId` (UUID, nullable, Foreign Key auf sich selbst)
- [ ] 2.2.1.6 `position` (Integer, für Sortierung)
- [ ] 2.2.1.7 `createdAt` (DateTime)
- [ ] 2.2.1.8 `updatedAt` (DateTime)

#### 2.2.2 Notes Table
- [ ] 2.2.2.1 `id` (UUID, Primary Key)
- [ ] 2.2.2.2 `title` (Text)
- [ ] 2.2.2.3 `content` (Text, Markdown)
- [ ] 2.2.2.4 `contentType` (Enum)
- [ ] 2.2.2.5 `folderId` (UUID, Foreign Key)
- [ ] 2.2.2.6 `isPinned` (Boolean)
- [ ] 2.2.2.7 `isArchived` (Boolean)
- [ ] 2.2.2.8 `isTrashed` (Boolean)
- [ ] 2.2.2.9 `trashedAt` (DateTime, nullable)
- [ ] 2.2.2.10 `mediaPath` (Text, nullable - für Audio/Bild)
- [ ] 2.2.2.11 `drawingData` (Text, nullable - JSON für Zeichnung)
- [ ] 2.2.2.12 `createdAt` (DateTime)
- [ ] 2.2.2.13 `updatedAt` (DateTime)

#### 2.2.3 Tags Table
- [ ] 2.2.3.1 `id` (UUID, Primary Key)
- [ ] 2.2.3.2 `name` (Text, unique)
- [ ] 2.2.3.3 `color` (Integer, Hex-Wert)
- [ ] 2.2.3.4 `createdAt` (DateTime)

#### 2.2.4 NoteTags Table (Many-to-Many)
- [ ] 2.2.4.1 `noteId` (UUID, Foreign Key)
- [ ] 2.2.4.2 `tagId` (UUID, Foreign Key)
- [ ] 2.2.4.3 Composite Primary Key (noteId, tagId)
